...
@Component
public class BranchTradingPeriodCommandConverter implements CommandConverter<BranchTradingPeriodCommand, Branch> {

	private final TradingPeriodCommandConverter tradingPeriodCommandConverter;
	
	public BranchTradingPeriodCommandConverter(TradingPeriodCommandConverter tradingPeriodCommandConverter) {
		this.tradingPeriodCommandConverter = tradingPeriodCommandConverter;
	}
